...
C# Coding Standards (Based on POCU, targeting C# 9.0)

**Core Topics**:
- Naming conventions (m prefix, b prefix, E/S prefixes)
- Code writing rules
...
| Method (public) | PascalCase (Verb+Noun) | `GetAge()`, `ProcessOrder()` |
...
// Struct: S prefix (readonly struct can be excluded)
public struct SUserID
{
    public int Value { get; }
}

// readonly record struct: S prefix not needed
...
- Filename = Class name (must match exactly)
- Partial class: `ClassName.SubName.cs`

## Reference Documentation

### [Naming Conventions](references/naming-conventions.md)
Complete naming rules:
- Details of m/mb prefixes
- Rules for E/S prefixes
- OrNull suffix patterns
- ALL_CAPS constant rules
...
- Details of prohibited patterns

### [Error Handling](references/error-handling.md)
Error handling patterns:
- Use Debug.Assert
- Handle exceptions only at boundaries
- Avoid null return/parameters
- Validation patterns
